                    ...
                    <div class="card shadow bg-light">
                        <div class="card-body bg-white px-5 py-3 border-bottom rounded-top">
                            <DataTable lazy responsiveLayout="scroll" paginator
                                ...
                                filterDisplay="menu"
                                sortMode="multiple" :value="resources" :rows="10" :rowsPerPageOptions="[10, 20, 50]"
        ...
        <Dialog v-model:visible="entity_form_visible" :modal="true"
            ...
            <form @submit.prevent="submit">
                <div class="row">
                    ...
                    <div class="col">
                        <InputText v-model="entity_form.unit" placeholder="Unit (cm, kg, etc.)"
                            :disabled="submitting" />
                    </div>
                    <div class="col">
                ...
                <div class="row mt-4">
                    <div class="col">
                        <Textarea v-model="entity_form.description" class="w-100" placeholder="Description" />
                    </div>
                </div>
            ...
            <form @submit.prevent="update_stock">
                <div class="grid">
                    ...
                    <div class="justify-self-center">
                        <InputNumber v-model="to_update_stock.new_stock" placeholder="Stock" :disabled="submitting"
                            required
                            class="w-100" />
                    </div>
