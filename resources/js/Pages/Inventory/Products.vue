    ...
    >
      ...
      <form @submit.prevent="submit">
        ...
        <div class="row mt-4 mb-2">
          <div class="col"><h5>Resources</h5></div>
          <div class="col-auto">
            <Button @click="increment_resources" class="me-2"
              >+ Add Resource</Button
            >
          </div>
        </div>
        <div
          v-for="(resource, index) in entity_form.resources"
          class="row mt-2"
          :key="index"
        >
          <div class="col-1">
          ...
          <div class="col-3">
            <InputNumber v-model="resource.quantity" class="w-100" />
          </div>
          <div class="col-2"></div>
        </div>
        <div class="row mt-4">
